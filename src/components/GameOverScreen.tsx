 ...
 */
export const GameOverScreen = ({ reason, day, onRestart }: GameOverProps) => (
  <motion.div
  ...
  >
    ...
    <motion.button
      ...
      whileTap={{ scale: 0.97 }}
      onClick={onRestart}
      className="flex items-center gap-3 mx-auto px-8 py-3 bg-president-gold text-black font-bold rounded-xl text-sm uppercase tracking-widest hover:bg-yellow-400 transition-colors"
    >
      <RotateCcw size={16} />
      Coba Lagi
    </motion.button>
